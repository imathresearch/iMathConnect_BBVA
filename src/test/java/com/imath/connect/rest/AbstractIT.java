    ...
    public static Archive<?> createTestArchive() {
       ...
       return ShrinkWrap.create(WebArchive.class, "test.war")
               ...
               .addClasses(EncryptedStringType.class, MainDB.class, UserConnect.class , Project.class, StandardConfiguration.class, Instance.class,
                       ...
                       JaxRsActivator.class, ProjectRest.class, com.imath.connect.security.SecurityManager.class,
                       ...
                       Constants.class, Resources.class, Util.class, Encryptor.class, AbstractIT.class, ProjectRestIT.class)
