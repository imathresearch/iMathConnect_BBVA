...
public class GeneralRestIT extends AbstractIT {
    ...
    public void getInfoIT() throws Exception {
        ...
        UserConnect owner2 = ucc.newUserConnect("mysAghnb", "ha@pepehsshgre.com", "imath", "958183402", "958183402", null);
        UserConnect owner3 = ucc.newUserConnect("mysghndsb", "ha@pepqwehhgre.com", "imath", "958183402", "958183402", null);
